...
namespace My::detail::MultiVisitor_ {
...
void MultiVisitor<Impl, AddPointer, PointerCaster,
  ...
  VisitorOf<BaseOfDerived>::template RegistOne<Derived>(
...
void MultiVisitor<Impl, AddPointer, PointerCaster, Bases...>::RegistOne(
    Func&& func) noexcept {
...
void MultiVisitor<Impl, AddPointer, PointerCaster, Bases...>::Regist(
    Funcs&&... func) noexcept {
  using BaseList = TypeList<Bases...>;
  static_assert(
      ((Length_v<Filter_t<BaseList, detail::MultiVisitor_::IsBaseOf<
...
class RawPtrMultiVisitor
    : public MultiVisitor<Impl, std::add_pointer_t,
...
class SharedPtrMultiVisitor
    : public MultiVisitor<Impl, std::shared_ptr,
                          detail::Visitor_::PointerCaster<std::shared_ptr>,
                          Bases...> {};
